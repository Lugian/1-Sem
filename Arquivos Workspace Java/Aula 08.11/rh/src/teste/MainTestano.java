...
public class MainTestano {

	static Scanner scan = new Scanner(System.in);
	static ArrayList<Testano> vacinas = new ArrayList<>();
	static int menu = 0;
	...
	public static void cadastrar() throws ParseException {
		...
		for (int i = 0; i < quantas; i++)
			vacinas.add(new Testano(scan.next(), scan.next(), scan.next(), scan.next()));
	}
	...
	public static void alterar() throws ParseException {
		...
		vacinas.set(indice, new Testano(scan.next(), scan.next(), scan.next(), scan.next()));
